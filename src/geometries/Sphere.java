...
public class Sphere extends Geometry{
    ...
    public boolean equals(Object o) {
        ...
        System.out.println("Objects.equals(_center, sphere2._center)"+ Objects.equals(_center, sphere2._center));
    ...
    public List<Point3D> findIntersections(Ray ray) {
        ...
        if (d <= this._radius) {
            ...
            if (0 < t1 || 0 < t2) {
                if (0 < t1)
                    list.add(new Point3D( ray.get_p0().add( ray.getDirection().scale(t1) )) );
                if (0 < t2)
                    list.add(new Point3D( ray.get_p0().add( ray.getDirection().scale(t2) )) );
                return list;
            }
        }
        return null;
